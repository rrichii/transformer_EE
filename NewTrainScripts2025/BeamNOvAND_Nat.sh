    ...
    for csv_file in "${CSV_files[@]}"; do
        ...
        if [[ "$json_base" == *"$csv_base"* ]]; then
            ...
            if [[ "$json_base" == *"_Lept_"* ]]; then
                ...
                short_base="${short_base#Numu_CC_Train_DUNEBeam_Natural_NOvAND_p1to10_ScalarLeptwNC_eventnum_All_NpNpi_}"

            else
              short_base="$json_base"
              short_base="${short_base#Numu_CC_Train_DUNEBeam_Natural_NOvAND_}"
